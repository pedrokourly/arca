...
export const apiService = {
  ...
  createMedicalRecordTriagem: (
    data: CreateTriagemMedicalRecordData,
    token: string,
  ) =>
  ...
  updateMedicalRecordTriagem: (
    recordId: string,
    data: UpdateTriagemMedicalRecordData,
    token: string,
  ) =>
  ...
  createMedicalRecordPsicoterapia: (
    data: CreatePsicoterapiaMedicalRecordData,
    token: string,
  ) =>
  ...
  updateMedicalRecordPsicoterapia: (
    recordId: string,
    data: UpdatePsicoterapiaMedicalRecordData,
    token: string,
  ) =>

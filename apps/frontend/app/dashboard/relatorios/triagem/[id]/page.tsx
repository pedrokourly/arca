...
export default function TriagemReportPage() {
  ...
  const fetchSessionData = async () => {
    ...
    try {
      ...
      if (triagemProntuario) {
        ...
        router.push(`/dashboard/relatorios/triagem/${sessionId}/edit`);
        return;
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiService.createMedicalRecordTriagem(payload, session.token);

      toast.success("Relatório de triagem salvo com sucesso!");
    ...
    <div className="container mx-auto py-6 max-w-4xl">
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="text-3xl font-bold">Preencher Relatório de Triagem</h1>
        </div>
        <p className="text-muted-foreground">
          Preencha as informações sobre a sessão de triagem realizada
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preencha os dados referentes à sessão de triagem
          </CardDescription>
        </CardHeader>
        <CardContent>
